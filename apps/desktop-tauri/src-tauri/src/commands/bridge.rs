...
impl From<Settings> for SettingsSnapshot {
    fn from(settings: Settings) -> Self {
        ...
        Self {
            ...
            demo_provider_ids: settings.demo_provider_ids.clone(),
            demo_scenario: settings.demo_scenario.as_str(),
            demo_seed: settings.demo_seed,
            demo_history_days: settings.demo_history_days,
            start_at_login: settings.start_at_login,
            start_minimized: settings.start_minimized,
            startup_destination: settings.startup_destination,
            last_settings_tab: settings.last_settings_tab,
            ...
            usage_step_notification_percent: settings.usage_step_notification_percent,
            ...
            provider_detail_windows: settings.provider_detail_windows,
            ...
            logo_variant: settings.logo_variant,
            logo_scale_percent: settings.logo_scale_percent,
