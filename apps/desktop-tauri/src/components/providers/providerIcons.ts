...
export const PROVIDER_ICON_REGISTRY: Record<string, ProviderIcon> = {
  ...
  deepinfra:   { id: "deepinfra",   brandColor: "#2a3275", fallbackLetter: "D", svgPath: RAW.deepinfra, contrastPlate: "#f2f4f7" },
  ...
  elevenlabs:  { id: "elevenlabs",  brandColor: "#111827", fallbackLetter: "E", svgPath: RAW.elevenlabs, contrastPlate: "#f2f4f7" },
  ...
  manus:       { id: "manus",       brandColor: "#34322d", fallbackLetter: "M", svgPath: RAW.manus, contrastPlate: "#f2f4f7" },
  ...
  venice:      { id: "venice",      brandColor: "#111827", fallbackLetter: "V", svgPath: RAW.venice, contrastPlate: "#f2f4f7" },
  ...
  devin:       { id: "devin",       brandColor: "#111827", fallbackLetter: "D", contrastPlate: "#f2f4f7" },
